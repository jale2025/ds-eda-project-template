...
def create_geo_map(file_path: str, output_file: str = 'house_geo_map.html'):
    '''
    ...
    try:
        ...
        # Convert zipcode to category for better coloring
        ...
        fig = px.scatter_mapbox(df,
                                ...
                                zoom=8,
                                height=800,
                                title="Geographic Distribution of Houses by Zipcode")
        ...
        print(f"Successfully generated map and saved it to {output_file}")
...
if __name__ == '__main__':
    csv_file = 'house_data_with_lat_long.csv'
    create_geo_map(csv_file)
